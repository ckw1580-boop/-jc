...
const routes = [
  ...
  { path: '/interaction', name: 'interaction', component: () => import('../views/InteractionView.vue'), meta: { title: '交互界面', description: '模拟与实际变量监视控制', requiresUser: true } },
  { path: '/errors', name: 'errors', component: () => import('../views/ErrorManualView.vue'), meta: { title: '错误信息手册', description: '模拟与实际连接诊断检索', requiresUser: true } },
  { path: '/settings', name: 'settings', component: () => import('../views/SettingsView.vue'), meta: { title: '设置', description: '外观与变量刷新参数', requiresUser: true } },
